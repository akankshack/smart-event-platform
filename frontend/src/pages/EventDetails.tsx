  ...
  if (!event) {
    return (
      <div className="max-w-md mx-auto text-center py-16 px-4">
        ...
        <h3 className="text-xl font-bold text-white mt-4 font-sans">Event not found</h3>
        <Link
          to="/"
          className="inline-flex items-center space-x-2 text-primary-light hover:text-white mt-4 font-semibold text-sm"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="relative rounded-2xl overflow-hidden border border-white/5 h-64 md:h-96 bg-white/5">
            ...
            />
            <span className="absolute top-4 left-4 bg-primary/20 backdrop-blur-md text-primary-light text-xs font-semibold px-3 py-1 rounded-full border border-primary/30">
              {event.category}
            </span>
          </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center space-x-1 text-xs text-primary-light hover:text-white transition font-medium mt-1"
                  >
            ...
            <div className="pt-4 border-t border-white/5">
              {event.status === 'Completed' ? (
                ...
                <button
                  ...
                  className="w-full bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 text-red-400 text-sm font-semibold py-2.5 rounded-xl transition duration-200"
                >
