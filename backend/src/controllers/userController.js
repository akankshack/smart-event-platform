...
exports.getEvents = async (req, res) => {
  try {
    ...
    // Find and populate organizer details
...
exports.getEventById = async (req, res) => {
  try {
    ...
    // Include additional registrations metadata
...
exports.registerForEvent = async (req, res) => {
  try {
    ...
    if (registeredCount >= event.capacity) {
      return res.status(400).json({ success: false, message: 'Registration full. Event has reached maximum capacity.' });
    }
...
exports.getRegisteredEvents = async (req, res) => {
  try {
    ...
    // Filter out populated elements where events might have been deleted but registration remains
